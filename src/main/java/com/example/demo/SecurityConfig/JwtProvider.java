...
public class JwtProvider {
     ...
     */
    /**
     * Extracts the user's email from the given JWT token. Note that the token
     * should not have the "Bearer " prefix.
     *
     * @param jwt The JWT token to extract the email from.
     * @return The user's email if the token is valid, or null if there is an
     * error.
     */
    /**
     * **** cb6ef09b-93b1-4b5a-90d0-5decc71b320d  ******
     */
